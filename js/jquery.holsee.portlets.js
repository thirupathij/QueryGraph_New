     ...
     add : function (portletOptions) { 
       return this.each(function(){       
         ...
         var portlet = $.extend({
           ...
           template: '<h4 class="box-header round-top"><span class="box-title">Test Portlet</span></h4>'+
                     '<div class="box-container-toggle"><div class="box-content">Test portlet body</div></div>',
           foreground: 'black',
           background: 'white'
         }, portletOptions);    
